...
| [Unit Tests (Image Cropper)](https://github.com/ankidroid/Anki-Android/blob/main/.github/workflows/tests_unit.yml)         | `./gradlew :AnkiDroid:testPlayDebugUnitTest --tests "com.ichi2.imagecropper.ImageCropperTest" --daemon`                                                                             | Unit test for the Image Cropper                 |
